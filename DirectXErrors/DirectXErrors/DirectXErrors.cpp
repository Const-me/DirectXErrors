...
#define USE_DIRECTDRAW
#define USE_INPUT
#define USE_DIRECT3D_9
#define USE_AUDIO
#define USE_DIRECT2D
#define USE_DXUT
#define USE_WIC
...
#define CHK_ERR_WIN32A( code )            case HRESULT_FROM_WIN32( code ) : return #code;
	switch( hr )
	{
...
#define CHK_ERR_WIN32A( code )            case HRESULT_FROM_WIN32( code ) : return L#code;
	switch( hr )
	{
#include "data/win32.inl"
#include "includeData.inl"
